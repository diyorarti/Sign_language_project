...
from signLanguage.entity.config_entity import (TrainingPipelineConfig,
                                               DataIngestionConfig)
...
class DataIngestion:
    ...
    def download_data(self):
        ...
        try:
            ...
            data_file_name = "Sign recoginition.v1i.yolov5pytorch.zip"
    ...
    def unzip_data(self, zip_file_path: str) -> str:
        """
        zip_file_path: str
